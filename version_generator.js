...
//远程服务器所在的url
var manifest = {
    packageUrl: 'http://jonle.ink/game/hotupdate-bubbleshooter/',
    remoteManifestUrl: 'http://jonle.ink/game/hotupdate-bubbleshooter/project.manifest',
    remoteVersionUrl: 'http://jonle.ink/game/hotupdate-bubbleshooter/version.manifest',
    version: '1.0.0',
    assets: {},
    searchPaths: []
};
...
//下面2个定义根据自己项目属性自行修改
var dest = './hotupdate/';	//生成热更包的路径
var src = './build/jsb-link/';	//构建之后的资源文件所在的路径
